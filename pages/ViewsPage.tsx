    ...
    <div className="space-y-12 pb-20">
      ...
      <section className="bg-white dark:bg-[#1a1a1a] p-10 rounded-[40px] border dark:border-white/5 shadow-sm space-y-8">
        <div className="max-w-3xl">
          ...
          <p className="text-slate-500 font-bold">시간당 조회수 상승 폭(Velocity)을 분석하여 폭발적인 성장 영상을 찾습니다.</p>
        </div>
      ...
      {isLoading ? (
        <div className="py-40 flex flex-col items-center justify-center gap-4 text-slate-400">
          ...
          <p className="font-black animate-pulse">실시간 조회수 성장 지표 분석 중...</p>
        </div>
      ) : isError ? (
      ...
      {!queryParam && !isLoading && (
        <div className="py-20 text-center space-y-4 opacity-30">
          ...
          <p className="text-xl font-black uppercase tracking-widest">키워드를 검색하여 조용히 뜨는 영상을 찾아보세요</p>
        </div>
      )}
    </div>
  );
